                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="slide-text">
                                    ...
                                    <a href="https://en.wikipedia.org/wiki/Albert_Einstein" class="boxed-btn">learn more <i class="fa fa-long-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="slide-text">
                                    ...
                                    <a href="https://en.wikipedia.org/wiki/Nelson_Mandela" class="boxed-btn">learn more <i class="fa fa-long-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <footer>
        <div class="container">
            <div class="row">
                ...
                <p class="copy-right">Design & Development by <a href="https://www.linkedin.com/in/sasindu-rashmika">Sasindu Rashmika</a>  Copyright By <a href = "">AZ High School </a>
